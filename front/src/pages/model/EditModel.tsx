...
export function EditModel() {
    const { libraryId,modelId } = useParams<{ libraryId: string, modelId: string }>();
    ...
    const simulateModel = async (): Promise<void> => {
        ...
        try {
            const response = await client.GET("/model/{id}/simulate", {params: {path: {id: modelId}}});
        ...
        <div className="flex flex-col h-screen w-full">
            <NavHeader
                breadcrumbs={[
                    ...
                    { label: dataLib?.title ?? "Unknown library", href: `/library/${dataLib?.id}`  },
