...
export interface components {
	schemas: {
		...
		"model.Model": {
			code?: string;
			componentsJson?: components["schemas"]["json.ModelComponents"][];
			connectionsJson?: components["schemas"]["json.Connection"][];
			createdAt?: string;
			deletedAt?: string;
			description?: string;
			id?: string;
			libId?: string;
			metadataJson?: components["schemas"]["json.ModelMetadata"];
			name?: string;
			portInJson?: components["schemas"]["json.ModelPort"][];
			portOutJson?: components["schemas"]["json.ModelPort"][];
