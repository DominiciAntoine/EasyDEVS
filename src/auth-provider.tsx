...
export const AuthProvider = ({ children }: { children: ReactNode }) => {
  ...
  const [token, setToken] = useState<string | null>(null); // Stocké en mémoire
  ...
  return (
    <AuthContext.Provider value={{ user, token, isAuthenticated: !!token, isLoading, login, register, logout, refreshAccessToken }}>
  {children}
